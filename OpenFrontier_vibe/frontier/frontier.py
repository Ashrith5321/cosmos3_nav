...
class Frontier:
    def __init__(self, frontier_feature: Optional[np.ndarray] = None):
        ...
        self.features: Dict[str, Any] = {
            # stable identity carried through merges; integer ids are
            # reallocated by the manager, uid is not (world-model memory key)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "id": self.id,
            "uid": self.uid,
            "wm_mean": self.features.get("wm_mean"),
            "wm_sigma": self.features.get("wm_sigma"),
            "wm_room_top": self.features.get("wm_room_top"),
            "wm_terms": self.features.get("wm_terms"),
