...
> **This fork (OpenFrontier_vibe)** extends OpenFrontier with
> **frontier-conditioned counterfactual world modeling**: each persistent
> frontier is treated as a "what-if" query to a goal-agnostic world model
> that predicts what exploration through it would reveal; predicted futures
> are matched against the language goal and combined with information gain,
> geodesic path cost, uncertainty, and revisit penalties into a predictive
> frontier utility, with closed-loop residual calibration. See
> [worldmodel/README.md](worldmodel/README.md) and run with
